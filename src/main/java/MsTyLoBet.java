...
public class MsTyLoBet {
   ...
   // private static Map<Integer,MsTyMatch> baseMsTyMatches = new HashMap<Integer, MsTyMatch>();
    ...
    public static void main(String[] args) throws Exception {
        ...
        MsTyLoBet myTyBet = new MsTyLoBet();
...
/*                logger.error("msTyMatch:"+msTyMatch);
       ...
       //     logger.info("msTyMatch:"+msTyMatch);
             ...
             *//*               if(prevMsTyMatch.getMatchTime()-oldMsTyMatch.getBaseTime()>10){
                        ...
                        int rankingCom = MatchDataUtils.compareRanking(prevMsTyMatch);
                        ...
                        logger.info("| "+prevMsTyMatch.getMatchNo()+" |secondPre："+secondPre+"|baseBetOdds:"+baseBetOdds+"|oldBetOdds:"+oldBetOdds+"|betOdds:"+betOdds+"|rankingCom:"+rankingCom);
                       ...
                       if( MatchDataUtils.compOnlyShoot(prevMsTyMatch,oldMsTyMatch)>=1
                        ...
                        if( MatchDataUtils.compOnlyShoot(prevMsTyMatch,oldMsTyMatch)>=1
                            ...
                            if(rankingPolicy){
                                ...
                                logger.info(prevMsTyMatch.getMasterTeamName()+"| "+prevMsTyMatch.getMatchNo()+"############second："+secondPre+"|"+"############betMoney："+prevMsTyMatch.getMoney());
                            }else {
