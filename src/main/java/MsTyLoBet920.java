...
public class MsTyLoBet920 {
    ...
    private static final Logger logger = LoggerFactory.getLogger(MsTyLoBet920.class);
   ...
   // private static Map<Integer,MsTyMatch> baseMsTyMatches = new HashMap<Integer, MsTyMatch>();
    ...
    public static void main(String[] args) throws Exception {
        ...
        MsTyLoBet920 myTyBet = new MsTyLoBet920();
...
/*                        } else if( MatchDataUtils.compOnlyShoot(prevMsTyMatch,oldMsTyMatch)>=1
                            ...
                            logger.info("唯有二倍定律高second,射门上升,开始投注..."+ prevMsTyMatch.getMasterTeamName()+"|"+prevMsTyMatch.getMatchNo());
                        }else if( MatchDataUtils.compOnlyShoot(prevMsTyMatch,oldMsTyMatch)>=1
                                && MatchDataUtils.compOnlyShoot(prevMsTyMatch,oldMsTyMatch.getBaseMatchData())>=1
                                && betOdds>0.83
                                && betOdds-oldBetOdds>0
