...
/*        matchMap.put("frdate","6/12/2019 12:00:00 AM");
        ...
        String contentLength = "84";
        if(day>9) contentLength = "85";
        ...
        method.setRequestHeader("Content-Length", contentLength);
       ...
       // method.setRequestHeader("Referer", "https://www."+MsHost+".com/Main/Sports/mSports/nss/repo.aspx?mode=4&ReportDate=6/12/2019%2012:00:00%20AM");
        String referer = "https://www."+MsHost+".com/Main/Sports/mSports/nss/repo.aspx?mode=4&ReportDate="+frdateStr+"%2012:00:00%20AM";
        ...
        while (!frdatedNextStr.equals(todate)){
            ...
            for (int i=1; i<repoDataArr.length;i++){
               ...
               // String isWin = s1[22];
                ...
                if(NumberUtils.toDouble(betMoney)<=10){
                    System.out.println("========test bet continue");
                    continue;
                }
...
/*        SimpleDateFormat simpleDateFormat = new SimpleDateFormat("yyyyMM-dd");
        ...
        if (args==null || args.length<2) {
            System.out.println("input args, sample :20190620 20190629");
            return;
        }
       ...
       msRepoParse.buildRepo(args[0],args[1]);
